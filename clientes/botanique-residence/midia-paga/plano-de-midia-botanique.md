...
|---|---|---|---|---|---|
| 0 — Captação VIP | hoje → 11/07 | ~21 | **R$ 1.150** | ~R$ 55 | encher a lista (aquisição fria) |
| 1 — Fase VIP | 12 → 18/07 | ~7 | **R$ 450** | ~R$ 64 | retargeting + WhatsApp (converter VIP) |
...
**Split por plataforma na Fase 0 (R$ 55/dia):** Meta **75%** (~R$ 41) · Google **25%** (~R$ 14).
- **Meta (~R$ 41/dia):** Cadastro VIP ~R$ 28 · CTWA ~R$ 9 · Retargeting ~R$ 4.
- **Google (~R$ 14/dia):** Search ~R$ 10 · Performance Max ~R$ 4.
