...
- Núcleo: **"Um condomínio fechado com lago e praia particular chegou a Cuiabá — e quem entra
  na lista VIP escolhe os melhores lotes antes da abertura geral."**
...
|---|---|---|---|---|---|
| 0 — Captação VIP | até 14/07 | ~22 | **R$ 73** | ≈ R$ 1.600 | encher a lista (aquisição fria) |
| 1 — Fase VIP | 15 → 18/07 | 4 | **R$ 110** | ≈ R$ 440 | retargeting + WhatsApp (converter VIP) |
| 2 — Lançamento geral | 19/07 em diante | ~3 na janela | **R$ 143** | ≈ R$ 430 | oferta/urgência + retargeting |
| **Total na janela** | ~29 dias | | | **≈ R$ 2.480** | (a Fase 2 segue depois) |
...
**Expectativa honesta de CPL:** a R$ 12/lead, os ~R$ 1.600 da captação dariam ~133 cadastros;
porém lote de ticket alto costuma ter **CPL maior (R$ 20–40)**, o que levaria a ~40–80 cadastros
...
- **Fase 1 — 15 → 18/07 (fase VIP):** reduzir aquisição fria; **intensificar retargeting +
  CTWA** para converter os cadastrados; escassez. E-mail 4 (15/07) e 5 (reta final, ~17/07).
...
chaves rotacionadas + webhook Praedium recriado. Data do acesso VIP **confirmada: 15/07** (geral 19/07).

## 15. Próximos passos
- Gerar **logos PMax** (1:1 e 4:1) a partir do kit de marca (posso fazer no Desktop).
- Confirmar o **nº de vagas VIP** (`{{VAGAS_VIP}}`) com a Urba. _(Data do acesso VIP já definida: **15/07**.)_
